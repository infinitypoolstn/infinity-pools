...
function freshSpecs() {
  return {
    poolBase: {
      price: 0, shape: 'geometric', freeform: '', size: '', depth: '', shapeText: '',
      jets: '', ledLights: '',
      sunShelf: { included: false, details: '' },
      spillover: '',
      ledgeSeating: { included: false, details: '' },
    },
    spaBase: { included: false, price: 0, size: '', jets: '', ledLights: '' },
...
function migrateSpecs(c) {
  ...
  c.specs = {
    poolBase: {
      ...
      spillover: (s.spillover && s.spillover.details) || (s.spillover && s.spillover.included ? 'Included' : ''),
