...
function freshSpecs() {
  return {
    ...
    fireLounge: { included: false, price: 0, size: '', jets: '', ledLights: '', details: '', items: [] },
...
function migrateSpecs(c) {
  ...
  if (!c.specs.fireLounge) c.specs.fireLounge = { included: false, price: 0, size: '', jets: '', ledLights: '', details: '', items: [] };
