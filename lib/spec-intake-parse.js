...
async function parseIntake(buffer) {
  ...
  const specs = {
    ...
    spaBase: {
      ...
      price: 0, size: t('spa_size'), jets: t('spa_jets'), ledLights: t('spa_led'), details: t('spa_det'), items: [],
    },
    ...
    coldPlunge: { included: ck('cp_inc') || !!(t('cp_det') || t('cp_led') || t('cp_addl')), price: 0, details: t('cp_det'), ledLights: t('cp_led'), additionalDetails: t('cp_addl'), items: [] },
